...
// normCharset returns a normalized character set name of charset.
func normCharset(charset string) (normCharset string, ok bool) {
	v, ok := encodings[strings.ToLower(charset)]
	if !ok {
		return "", false
	}
...
var encodings = map[string]struct {
	...
	"unicode-1-1-utf-8":   {unicode.UTF8, "utf-8"},
