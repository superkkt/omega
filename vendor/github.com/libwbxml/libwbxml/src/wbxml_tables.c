...
const WBXMLTagEntry sv_airsync_tag_table[] = {
    ...
    { "AssistantPhoneNumber", 	0x01, 0x07 }, /* corrected in libwbxml 0.11.0 */
    ...
    { "BusinessAddressCountry", 0x01, 0x0e }, /* since r1.0 */
    { "BusinessAddressPostalCode",	0x01, 0x0f }, /* since r1.0 */
    { "BusinessAddressState",	0x01, 0x10 }, /* since r1.0 */
    { "BusinessAddressStreet",  0x01, 0x11 }, /* since r1.0 */
    ...
    { "OtherAddressCity",       0x01, 0x2d }, /* since r1.0 */
    { "OtherAddressCountry",    0x01, 0x2e }, /* since r1.0 */
    { "OtherAddressPostalCode", 0x01, 0x2f }, /* since r1.0 */
    { "OtherAddressState",      0x01, 0x30 }, /* since r1.0 */
    { "OtherAddressStreet",     0x01, 0x31 }, /* since r1.0 */
    ...
    { "ReplyTo",                0x02, 0x19 }, /* supported since v2.5 */
    ...
    { "Type", 		        0x02, 0x29 }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "Until",			0x02, 0x2a }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "Occurrences",		0x02, 0x2b }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "Interval",		0x02, 0x2c }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "DayOfWeek",		0x02, 0x2d }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "DayOfMonth",		0x02, 0x2e }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "WeekOfMonth",		0x02, 0x2f }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "MonthOfYear",		0x02, 0x30 }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    ...
    { "Status",			0x02, 0x3b }, /* supported since v12.0 */
    ...
    { "Email",			0x04, 0x09 }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "Name",			0x04, 0x0a }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    ...
    { "Deleted",		0x04, 0x15 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: Exception_IsDeleted */
    { "ExceptionStartTime",	0x04, 0x16 }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "Location",               0x04, 0x17 }, /* supported since v2.5 */
    { "MeetingStatus",          0x04, 0x18 }, /* supported since v2.5 */
    { "OrganizerEmail",		0x04, 0x19 }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "OrganizerName",		0x04, 0x1a }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "Recurrence",             0x04, 0x1b }, /* supported since v2.5 */
    { "Type",			0x04, 0x1c }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "Until",			0x04, 0x1d }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "Occurrences",		0x04, 0x1e }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "Interval",		0x04, 0x1f }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "DayOfWeek",		0x04, 0x20 }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "DayOfMonth",		0x04, 0x21 }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "WeekOfMonth",		0x04, 0x22 }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    { "MonthOfYear",		0x04, 0x23 }, /* corrected in libwbxml 0.11.0, supported since v2.5 */
    ...
    { "AttendeeStatus",		0x04, 0x29 }, /* corrected in libwbxml 0.11.0, supported since v12.0 */
    { "AttendeeType",		0x04, 0x2a }, /* corrected in libwbxml 0.11.0, supported since v12.0 */
    ...
    { "Type",			0x09, 0x10 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceType */
    { "Start",			0x09, 0x11 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceStart */
    { "Until",			0x09, 0x12 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceUntil */
    { "Occurrences",		0x09, 0x13 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceOccurrences */
    { "Interval",		0x09, 0x14 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceInterval */
    { "DayOfMonth",		0x09, 0x15 }, /* supported since v2.5, changed in r8.0, r1.0: RecurrenceDayOfMonth */
    { "DayOfWeek",		0x09, 0x16 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceDayOfWeek */
    { "WeekOfMonth",		0x09, 0x17 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceWeekOfMonth */
    { "MonthOfYear",		0x09, 0x18 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceMonthOfYear */
    { "Regenerate",		0x09, 0x19 }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceRegenerate */
    { "DeadOccur",		0x09, 0x1a }, /* corrected in libwbxml 0.11.0, supported since v2.5, changed in r8.0, r1.0: RecurrenceDeadOccour */
    ...
    { "RightsManagementInformation",   0x12, 0x2b }, /* r8.0: not supported when the MS-ASProtocolVersion header is set to 14.0 or 12.1 */
    ...
    { "RemoveRightsManagementProtection",0x18, 0x18 }, /* since r8.0? */
